...
/* Ekran çözünürlüğüne göre buffer ayarı */
#define HOR_LEN 	5
...
void ST7789_Fill_Color(uint16_t color)
{
	...
	#ifdef USE_DMA
        /* Renk verisini buffer'a hazırla */
        uint16_t swapped_color = (color << 8) | (color >> 8);
		for (i = 0; i < ST7789_WIDTH * HOR_LEN; i++) disp_buf[i] = swapped_color;
...
void ST7789_Test(void)
{
	...
	HAL_Delay(500);
	ST7789_WriteString(10, 20, "STM32G071 TEST", Font_11x18, RED, WHITE);
	HAL_Delay(1000);
    ...
    HAL_Delay(500);
    ST7789_Fill_Color(BLACK);
    ST7789_WriteString(30, 100, "CALISIYOR!", Font_16x26, GBLUE, BLACK);
}
